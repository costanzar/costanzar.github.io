...
Temperature and CO<sub>2</sub> are measured at key positions throughout the room, while the heat input from computers is metered and occupancy is recorded. Together, these measurements provide insight into the flow and mixing within the space and allow us to estimate the room energy budget.
